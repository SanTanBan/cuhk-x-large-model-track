...
BASE_F, OUT_F, DRY = arg('base', 'src/best_nv_final_W.json'), arg('out', 'src/best_nb_W.json'), '--dry-run' in ARGS
...
G_NEW = {'w_nb_comb': [0, 0.5, 1, 2, 4], 'w_nb_bel': [0, 0.25, 0.5, 1, 2], 'thr_m': [-2.5, -2, -1.5]}
