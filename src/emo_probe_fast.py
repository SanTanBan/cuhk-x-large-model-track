...
V = [
    ('imu', 5, 'et400_leaf2', lambda: ET(400, min_samples_leaf=2, n_jobs=-1, random_state=0)),
    ('imu', 5, 'et400_leaf1_mf0.3', lambda: ET(400, min_samples_leaf=1, max_features=0.3, n_jobs=-1, random_state=0)),
    ('imu+skel', 5, 'et400_leaf2', lambda: ET(400, min_samples_leaf=2, n_jobs=-1, random_state=0)),
    ('imu', 5, 'rf400_leaf1', lambda: RF(400, min_samples_leaf=1, n_jobs=-1, random_state=0)),
    ('imu', 2, 'rf400_leaf2 min_n=2', lambda: RF(400, min_samples_leaf=2, n_jobs=-1, random_state=0)),
]
print('reference (full probe): imu rf500_leaf2 = 0.464, the sub12 emotion model')
